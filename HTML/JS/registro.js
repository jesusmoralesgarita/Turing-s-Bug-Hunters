    ...
    form.addEventListener(
      ...
      async (event) => {
        ...
        if (!form.checkValidity() || !isFormValid) {
          ...
          //const apellidos = document.getElementById("contact-lastname").value;
          //const direccion = document.getElementById("contact-address").value;
          const telefono = document.getElementById("contact-number").value;
